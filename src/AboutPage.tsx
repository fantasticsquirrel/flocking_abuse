...
export function AboutPage() {
  return <PublicShell current="about" skip="Skip to About"><main id="main-content" tabIndex={-1} className="content-page">
    ...
    <section><h2>Surveillance accountability, with receipts</h2><p>The Abusive Surveillance State (TASS) documents reported misuse, overreach, policy failures, legal challenges, and accountability involving automated license-plate readers, facial recognition, camera networks, and related surveillance systems. The project began with Flock Safety and expanded as the same patterns appeared across vendors and technologies.</p></section>
