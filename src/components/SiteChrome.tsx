...
export function SiteHeader({ current }: { current: 'incidents' | 'unverified' | 'about' }) {
...
export function PublicShell({ current, skip, children }: { current: 'incidents' | 'unverified' | 'about'; skip: string; children: ReactNode }) {
